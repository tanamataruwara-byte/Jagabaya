...
const KAMUS = {
  ...
  "widodari":     { arti: "dewi kahyangan yang cantik dan bisa terbang",    asal: "Sanskerta: vidyādharī" },
  ...
  "meri":         { arti: "iri hati; dengki; cemburu",                      asal: "Jawa" },
...
const SOAL_KUIS = {
  1: [
    ...
    { soal:'Apa artine tembung "widodari"?', p:['Penyihir jahat','Dewi kahyangan sing bisa mabur','Raksasa betina','Putri raja'], b:1 },
  ...
  2: [
    ...
    { soal:'Sapa jenenge ibune Malin Kundang?', p:['Purbasari','Mande Rubayah','Nawang Wulan','Roro Jonggrang'], b:1 },
    ...
    { soal:'Apa sebabé Malin Kundang dikutuk dadi watu?', p:['Amarga kalah perang','Amarga ngapusi kancane','Amarga durhaka marang ibune','Amarga nyolong bandha kerajaan'], b:2 },
